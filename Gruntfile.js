...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy:{
      ...
      build:{
        //The line bellow can be changed accordding to the project
        src:['**','!node_modules/**','!**/Gruntfile.js','!**/package.json','!less/**','!images/psd/**','!sacodacapela/**',"!docs/**"],
        dest:'dist',
        expand:true
      },
      endbuild:{
      ...
      github:{
        src:['**','!node_modules/**','!sacodacapela/**','!dist/**'],
        dest:'sacodacapela/github',
        expand:true
      }
    },
    watch: {
